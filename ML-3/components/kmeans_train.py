"""K-means 聚类 — WDBC 数据集（去标签）训练、评估与可视化"""
...
y_pred : ndarray
    聚类标签。
"""
def run_kmeans_pipeline(X, y_true=None, n_clusters=2, random_state=42):
    ...
    scatter = plt.scatter(X_pca[:,0], X_pca[:,1], c=y_pred, cmap='coolwarm', edgecolors='k', s=60)
