"""LightGBM 分类器 — Adult Income 数据集（14 维特征）训练、评估与可视化（CPU 模式）"""
...
def plot_pca_decision_boundary(X, y, class_names, **kwargs):
    ...
    plt.title(f'PCA 降维 + LightGBM 决策边界\n'
